...
// Method To Create Tables   *************************************************************************************	
	static void createTable() {
        ...
        try {
			...
			String sql_creat_invoice_item= "IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Invoice_Item') "
					...
					+ ");";
			st.executeUpdate(sql_creat_invoice_item);
